...
public class PowerupController
{
    ...
    public void frame() {
        ...
        while (iter.hasNext()) {
            ...
            if (CustomMath.CircleRectangleCollision(powerup.getXPos(), powerup.getYPos(), powerup.getRadius(), bat.XPositionGeben(), bat.YPositionGeben(), bat.getHeight(), bat.getWidth()) > 0) {
                clearPowerupEffects();
